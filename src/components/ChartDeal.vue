<template>
  <div
    id="multiMap"
    style="width:100%;height:100%;border: 3px solid #07B3B1;"
  ></div>
</template>
...
export default {
  ...
  methods: {
    initMap () {
      const self = this
      const topRightNavigation = new BMap.NavigationControl({ anchor: BMAP_ANCHOR_TOP_RIGHT, type: BMAP_NAVIGATION_CONTROL_LARGE })
      const mapStyle = {
